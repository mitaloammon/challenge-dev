  ...
  <form @submit.prevent="submit">
    <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
      <div class="flex flex-col space-y-1">
        ...
        <SectionTitle class="text-xs text-gray-600">Informações essenciais para inserção de Serviços no sistema.
        </SectionTitle>
      </div>
      ...
      <div class="mt-10 grid grid-cols-1 gap-6 max-md:grid-cols-1">
        ...
        <div>
          <span class="p-float-label">
            <InputText v-model="form.descricao" id="descricao" type="text" class="w-full" required maxlength="50" />
...
function submit() {
  ...
  submitForm.post(route("store.ConfigServicos"), {
    preserveState: true,
    onError: (errors) => {
