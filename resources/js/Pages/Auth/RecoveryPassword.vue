  ...
  <form @submit.prevent="submit" class="h-screen flex body-background">
    <div class="bg-white w-[24rem] m-auto p-10 rounded-lg shadow-md flex flex-col justify-center">
      ...
      <div class="mb-4 mt-6 flex flex-col text-center space-y-2">
        <span class="font-bold">Recuperar Password de acesso</span>
        <span class=" text-xs">Para ter acesso ao sistema, insira uma Password segura e memorável!</span>
      </div>
      <div class="space-y-5">
        ...
        <div class="flex justify-center">
          <a :href="route('login')" class="text-proconph uppercase font-extrabold text-[12px]">Tela de Login</a>
        </div>
        <div class="flex justify-center">
...
function submit() {
  ...
  form.post(route("recovery.password.send", { code: props.code }), {
