  ...
  <form @submit.prevent="submit">
    <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
      <div class="flex flex-col space-y-1">
        ...
        <SectionTitle class="text-xs text-gray-600">Informações essenciais para inserção de Permissões no sistema.</SectionTitle>
      </div>
...
function submit() {
  ...
  submitForm.post(route("store.Permissoes2"), {
    preserveState: true,
    onError: () => {
