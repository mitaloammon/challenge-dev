  ...
  <form @submit.prevent="submit">
    <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
      <div class="flex flex-col space-y-1">
        ...
        <SectionTitle class="text-xs text-gray-600">Informações essenciais para edição de Clientes no sistema.
        </SectionTitle>
      </div>
      ...
      <div class="mt-10 grid grid-cols-1 gap-6 max-md:grid-cols-1">
        ...
        <div>
          <span class="p-float-label">
            <InputText v-model="form.telefone" id="telefone" type="text" class="w-full" required maxlength="50" />
        ...
        <div>
          <span class="p-float-label">
            <InputText v-model="form.email" id="email" type="text" class="w-full" required maxlength="50" />
        ...
        <div>
          <span class="p-float-label">
            <InputText v-model="form.endereco" id="endereco" type="text" class="w-full" required maxlength="50" />
...
created_at: $propsPage?.value.ConfigClientes?.created_at,
