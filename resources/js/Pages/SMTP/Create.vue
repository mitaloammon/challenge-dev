  ...
  <form @submit.prevent="submit">
    <section class="mt-6 bg-white rounded-sm p-10 shadow-sm" v-if="currentNav == 1">
      <div class="flex flex-col space-y-1">
        ...
        <SectionTitle class="text-xs text-gray-600">Informações essenciais para inserção de SMTP no sistema.</SectionTitle>
      </div>
...
<div>
  <span class="p-float-label">
   <InputText v-model="form.password" id="password" type="text" class="w-full" required />
...
function submit() {
  ...
  submitForm.post(route("store.SMTP"), {
    preserveState: true,
    onError: () => {
